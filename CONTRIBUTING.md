Contributing to Zubit Core
============================

The Zubit Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Zubit Core project, and is not to be
confused with overall Zubit Network Protocol consensus changes.

Whether a pull request is merged into Zubit Core rests with the project merge
...
Patches that change Zubit consensus rules are considerably more involved than
...
Where a patch set proposes to change the Zubit consensus, it must have been
...
The project leader is the release manager for each Zubit Core release.
