...
RESOURCES += src/qt/zubit.qrc src/qt/zubit_locale.qrc

TRANSLATIONS += src/qt/locale/zubit_bg.ts \
                src/qt/locale/zubit_de.ts \
                src/qt/locale/zubit_en.ts \
                src/qt/locale/zubit_es.ts \
                src/qt/locale/zubit_fi.ts \
                src/qt/locale/zubit_fr.ts \
                src/qt/locale/zubit_it.ts \
                src/qt/locale/zubit_ja.ts \
                src/qt/locale/zubit_pl.ts \
                src/qt/locale/zubit_pt.ts \
                src/qt/locale/zubit_ru.ts \
                src/qt/locale/zubit_sk.ts \
                src/qt/locale/zubit_sv.ts \
                src/qt/locale/zubit_vi.ts \
                src/qt/locale/zubit_zh_CN.ts \
                src/qt/locale/zubit_zh_TW.ts
