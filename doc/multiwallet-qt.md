...
In order to support loading of multiple wallets in zubit-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is zubit.cpp.
...
Changes to zubit.cpp
----------------------
zubit.cpp is the entry point into zubit-qt, and as such, will require some minor modifications to provide hooks for
