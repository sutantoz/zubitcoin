...
This mechanism has been integrated into Bitcore-Node-Zubit which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Zubit-Project/insight-api-zubit#web-socket-api](https://github.com/Zubit-Project/insight-api-zubit#web-socket-api) 
* API: [https://github.com/Zubit-Project/insight-api-zubit#swifttx-transactions](https://github.com/Zubit-Project/insight-api-zubit#swifttx-transactions) 
...
By default, the Zubit Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Zubit Core daemon:
