...
#   c) node1 mines 32 blocks, so now node 0 has 60001zbit, node 1 has 4250zbit, node2 has none.
#   d) node0 sends 601 zbit to node2, in two transactions (301 zbit, then 300 zbit).
