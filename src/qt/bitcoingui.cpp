                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Zubit Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Zubit address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and zubit: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zZBIT"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Zubit Core"), this);
    aboutAction->setStatusTip(tr("Show information about Zubit Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Zubit"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Zubit addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Zubit addresses"));
    ...
    openAction->setStatusTip(tr("Open a Zubit: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Zubit Core help message to get a list with possible Zubit command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Zubit Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Zubit network", "", count));
}
...
{
    QString strTitle = tr("Zubit Core"); // default title
