...
/* Zubit GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Zubit"
#define QAPP_ORG_DOMAIN "zubit.org"
#define QAPP_APP_NAME_DEFAULT "Zubit-Qt"
#define QAPP_APP_NAME_TESTNET "Zubit-Qt-testnet"
