...
/** Utility functions used by the Zubit Qt UI.
 */
namespace GUIUtil
{
...
// Render Zubit addresses in monospace font
...
// Parse "zubit:" URI into recipient object, return true on successful parsing
