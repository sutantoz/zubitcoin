                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzZBITPathCustom = GetArg("-zzbitbackuppath", "");
    ...
    if(!strzZBITPathCustom.empty()) {
        ui->wallet_customzzbitbackuppath->setText(QString::fromStdString(strzZBITPathCustom));
        ui->wallet_customzzbitbackuppath_label->setVisible(true);
        ui->wallet_customzzbitbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzZBITPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Zubit RPC console.") + "<br>" +
