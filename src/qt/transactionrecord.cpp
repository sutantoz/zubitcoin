...
QList<TransactionRecord> TransactionRecord::decomposeTransaction(const CWallet* wallet, const CWalletTx& wtx)
{
    ...
    if (wtx.IsCoinStake()) {
        ...
        if (wtx.IsZerocoinSpend() && (fZSpendFromMe || wallet->zzbitTracker->HasMintTx(hash))) {
            //zZBIT stake reward
            sub.involvesWatchAddress = false;
            sub.type = TransactionRecord::StakeZZBIT;
...
bool IsZZBITType(TransactionRecord::Type type)
{
    switch (type) {
        case TransactionRecord::StakeZZBIT:
...
void TransactionRecord::updateStatus(const CWalletTx& wtx)
{
    ...
    else if (type == TransactionRecord::Generated || type == TransactionRecord::StakeMint || type == TransactionRecord::StakeZZBIT || type == TransactionRecord::MNReward) {
