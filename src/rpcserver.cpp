...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Zubit features */
        {"zubit", "masternode", &masternode, true, true, false},
        {"zubit", "listmasternodes", &listmasternodes, true, true, false},
        {"zubit", "getmasternodecount", &getmasternodecount, true, true, false},
        {"zubit", "masternodeconnect", &masternodeconnect, true, true, false},
        {"zubit", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"zubit", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"zubit", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"zubit", "masternodecurrent", &masternodecurrent, true, true, false},
        {"zubit", "masternodedebug", &masternodedebug, true, true, false},
        {"zubit", "startmasternode", &startmasternode, true, true, false},
        {"zubit", "createmasternodekey", &createmasternodekey, true, true, false},
        {"zubit", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"zubit", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"zubit", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"zubit", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"zubit", "getmasternodescores", &getmasternodescores, true, true, false},
        {"zubit", "mnbudget", &mnbudget, true, true, false},
        {"zubit", "preparebudget", &preparebudget, true, true, false},
        {"zubit", "submitbudget", &submitbudget, true, true, false},
        {"zubit", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"zubit", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"zubit", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"zubit", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"zubit", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"zubit", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"zubit", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"zubit", "checkbudgets", &checkbudgets, true, true, false},
        {"zubit", "mnsync", &mnsync, true, true, false},
        {"zubit", "spork", &spork, true, true, false},
        {"zubit", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzzbitseed", &getzzbitseed, false, false, true},
        {"zerocoin", "setzzbitseed", &setzzbitseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzzbit", &searchdzzbit, false, false, true},
        {"zerocoin", "dzzbitstate", &dzzbitstate, false, false, true}
...
{
    return "> zubit-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:6643/\n";
}
