...
extern UniValue setzzbitseed(const UniValue& params, bool fHelp);
extern UniValue getzzbitseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzzbit(const UniValue& params, bool fHelp);
extern UniValue dzzbitstate(const UniValue& params, bool fHelp);
