...
#ifndef Zubit_STAKEINPUT_H
#define Zubit_STAKEINPUT_H
...
public:
    ...
    virtual bool IsZZBIT() = 0;
    virtual CDataStream GetUniqueness() = 0;
};


// zZBITStake can take two forms
// 1) the stake candidate, which is a zcmint that is attempted to be staked
// 2) a staked zzbit, which is a zcspend that has successfully staked
...
public:
    ...
    bool IsZZBIT() override { return true; }
...
public:
    ...
    bool CreateTxIn(CWallet* pwallet, CTxIn& txIn, uint256 hashTxOut = 0) override;
    bool CreateTxOuts(CWallet* pwallet, vector<CTxOut>& vout, CAmount nTotal) override;
    bool IsZZBIT() override { return false; }
};


#endif //Zubit_STAKEINPUT_H
