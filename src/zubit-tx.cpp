...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Zubit Core zubit-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  zubit-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded zubit transaction") + "\n" +
                               "  zubit-tx [options] -create [commands]   " + _("Create hex-encoded zubit transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded zubit transaction
